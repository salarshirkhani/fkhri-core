...
class Fkhri_Ticker_Carousel extends Widget_Base {

    public function get_name() { return 'fkhri-ticker-carousel'; }
    public function get_title() { return 'Fkhri – Ticker Carousel'; }
    public function get_icon() { return 'eicon-carousel'; }
    public function get_categories() { return ['fkhri']; }
    public function get_keywords() { return ['ticker','marquee','loop','carousel','tag','badge','fkhri']; }

    public function get_style_depends() {
        return ['fkhri-ticker-carousel'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            'name'     => 'typo',
            'selector' => '{{WRAPPER}} .fkhri-ticker-item',
        ]);
        ...
        $this->add_control('pad_item', [
            ...
            'selectors' => [
                '{{WRAPPER}} .fkhri-ticker-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
    ...
    protected function render() {
        ...
        echo '<div class="fkhri-ticker-carousel '.$pause_class.'" data-direction="'.$dir.'" data-speed="'.$speed.'" data-gap="'.$gap.'" '.$wrap_style.'>';
        echo '  <div class="fkhri-ticker-track">';
        foreach ($items as $it) {
            $text  = trim($it['text'] ?? '');
            if ($text === '') continue;
            ...
            echo '<div class="fkhri-ticker-item" style="'.esc_attr($style).'">';
            if ($link) {
