...
class Fkhri_Breadcrumb extends Widget_Base {

	public function get_name() { return 'fkhri-breadcrumb'; }
	public function get_title() { return 'Fkhri – Breadcrumb'; }
	public function get_icon() { return 'eicon-breadcrumbs'; }
	public function get_categories() { return [ 'fkhri' ]; }

	public function get_style_depends() { return [ 'fkhri-breadcrumb' ]; }
	...
	protected function register_controls() {
		...
		$this->add_control('bg_color', [
			...
			'default' => '#f8fafb',
			'selectors' => [
				'{{WRAPPER}} .fkhri-bc' => 'background-color: {{VALUE}}',
			],
		]);
		...
		$this->add_control('border_color', [
			...
			'default' => '#e5e7eb',
			'selectors' => [
				'{{WRAPPER}} .fkhri-bc' => 'border-color: {{VALUE}}',
			],
		]);
		...
		$this->add_control('link_color', [
			...
			'default' => '#0f172a',
			'selectors' => [
				'{{WRAPPER}} .fkhri-bc a' => 'color: {{VALUE}}',
			],
		]);
		...
		$this->add_control('link_hover', [
			...
			'default' => '#16a34a',
			'selectors' => [
				'{{WRAPPER}} .fkhri-bc a:hover' => 'color: {{VALUE}}',
			],
		]);

		$this->add_group_control(Group_Control_Typography::get_type(), [
			'name'     => 'typography',
			'selector' => '{{WRAPPER}} .fkhri-bc',
		]);
	...
	protected function render() {
		...
		if ( 'yes' === $s['use_yoast'] && function_exists('yoast_breadcrumb') ) {
			echo '<nav class="fkhri-bc" aria-label="Breadcrumb">';
		...
		echo '<nav class="fkhri-bc" aria-label="Breadcrumb"><ol>';
		$last = count($items) - 1;
