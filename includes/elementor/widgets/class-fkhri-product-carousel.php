...
class Fkhri_Product_Carousel extends Widget_Base {
  public function get_name() { return 'fkhri-product-carousel'; }
  public function get_title() { return 'Fkhri – Product Carousel'; }
  ...
  public function get_style_depends(){
    return [
      'swiper',                  // CSS Swiper
      'fkhri-product-carousel' // CSS خودت
    ];
  }
  ...
  public function get_script_depends(){
    return [
      ...
      'fkhri-product-carousel'  // JS خودت
    ];
  }
  ...
  protected function render(){
    ...
    <div id="<?php echo esc_attr($uid); ?>" class="fkhri-pc">
      <?php if('yes'===$s['show_arrows']): ?>
        <button class="fkhri-pc__arrow fkhri-pc__prev" type="button" aria-label="قبلی"></button>
        <button class="fkhri-pc__arrow fkhri-pc__next" type="button" aria-label="بعدی"></button>
      <?php endif; ?>
    
      <div class="fkhri-pc__swiper swiper" data-fkhri-swiper='<?php echo wp_json_encode($opts); ?>' dir="rtl">
        <div class="fkhri-pc__list swiper-wrapper"><!-- ایزوله؛ دیگه ul.products نیست -->
    
          <?php if($q->have_posts()): while($q->have_posts()): $q->the_post(); global $product; ?>
            <div class="fkhri-pc__item swiper-slide"><!-- ایزوله؛ دیگه li.product نیست -->
              <div class="fkhri-card">
                <a class="fkhri-card__thumb" href="<?php the_permalink(); ?>">
                  <?php if (has_post_thumbnail()) {
                    the_post_thumbnail('woocommerce_thumbnail',['class'=>'fkhri-card__img']);
                  } else {
                    echo wc_placeholder_img('woocommerce_thumbnail',['class'=>'fkhri-card__img']);
                  } ?>
                </a>
    
                <div class="fkhri-card__body">
                  <h3 class="fkhri-card__title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                  <div class="fkhri-card__price"><?php echo $product ? wp_kses_post($product->get_price_html()) : ''; ?></div>
          ...
          <?php endwhile; wp_reset_postdata(); else: ?>
            <div class="fkhri-pc__item swiper-slide"><p><?php esc_html_e('محصولی یافت نشد.','fkhri'); ?></p></div>
          <?php endif; ?>
