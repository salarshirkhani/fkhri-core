...
class Fkhri_Ajax_Search extends Widget_Base {

    public function get_name() { return 'fkhri-ajax-search'; }
    public function get_title() { return 'Fkhri – Ajax Search'; }
    public function get_icon() { return 'eicon-site-search'; }
    public function get_categories() { return ['fkhri']; }
    public function get_keywords() { return ['search','ajax','fkhri','woocommerce','product']; }

    public function get_style_depends() {
        return ['fkhri-ajax-search'];
    }
    ...
    protected function render() {
        ...
        $nonce = wp_create_nonce('fkhri_ajax_search');
        $data  = [
        ...
        <div class="<?php echo esc_attr(implode(' ', $root_classes)); ?>" <?php echo implode(' ', $attrs); ?>>
            <div class="fkhri-ajax-search__field">
                <span class="fkhri-ajax-search__clear" aria-label="پاک کردن">×</span>
                <input type="search" class="fkhri-ajax-search__input" placeholder="<?php echo esc_attr($data['placeholder']); ?>" autocomplete="off" aria-autocomplete="list" aria-expanded="false" />
                <span class="fkhri-ajax-search__icon" aria-hidden="true">🔎</span>
            </div>
    
            <div class="fkhri-ajax-search__results" role="listbox" aria-label="نتایج"></div>
