...
class Fkhri_Counter extends Widget_Base {

    public function get_name() { return 'fkhri-counter'; }
    public function get_title() { return 'Fkhri – Counter'; }
    ...
    public function get_style_depends() { return ['fkhri-counter']; }
    public function get_script_depends(){ return ['fkhri-counter']; }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(Group_Control_Background::get_type(), [
            'name'     => 'wrap_bg',
            'selector' => '{{WRAPPER}} .fkhri-counter',
        ]);
        ...
        $this->add_control('wrap_radius', [
            ...
            'size_units' => ['px','%','em'],
            'selectors'  => [
                '{{WRAPPER}} .fkhri-counter' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
        ]);
        ...
        $this->add_control('wrap_padding', [
            ...
            'size_units' => ['px','%','em'],
            'selectors'  => [
                '{{WRAPPER}} .fkhri-counter' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ]
        ]);
        ...
        $this->add_control('gap', [
            ...
            'min'   => 0,
            'default' => 8,
            'selectors' => ['{{WRAPPER}} .fkhri-counter' => '--sc-gap: {{VALUE}}px;'],
        ]);
        ...
        $this->add_control('align', [
            ...
            'default'   => 'center',
            'selectors' => ['{{WRAPPER}} .fkhri-counter' => 'justify-items: {{VALUE}}; text-align: {{VALUE}};'],
        ]);
    ...
    protected function render() {
        ...
        ?>
        <div class="fkhri-counter" <?php echo implode(' ', $attrs); ?>>
