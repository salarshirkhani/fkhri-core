...
/**
 * AJAX: fkhri_ajax_search
 * returns JSON: { ok:1, html:'...', count: N }
 */
add_action('wp_ajax_fkhri_ajax_search', 'fkhri_ajax_search_handler');
add_action('wp_ajax_nopriv_fkhri_ajax_search', 'fkhri_ajax_search_handler');

function fkhri_ajax_search_handler() {
    // Basic guards
    if ( ! isset($_POST['_wpnonce']) || ! wp_verify_nonce($_POST['_wpnonce'], 'fkhri_ajax_search') ) {
