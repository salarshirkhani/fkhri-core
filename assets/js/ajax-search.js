(function($){
  ...
  function openResults($wrap){
    ...
    if (!$wrap.find('.fkhri-ajax-search__backdrop').length) {
      const $bd = $('<div class="fkhri-ajax-search__backdrop" />');
      $('body').append($bd);
  ...
  function closeResults($wrap){
    ...
    $wrap.find('.fkhri-ajax-search__results').empty();
    $('.fkhri-ajax-search__backdrop').remove();
  }
  ...
  function initAjaxSearch($root){
    const $input   = $root.find('.fkhri-ajax-search__input');
    const $clear   = $root.find('.fkhri-ajax-search__clear');
    const $results = $root.find('.fkhri-ajax-search__results');
  ...
  $(function(){
    $('.fkhri-ajax-search').each(function(){
      initAjaxSearch($(this));
    });
  });
